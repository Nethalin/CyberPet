...
public class Animal {
    ...
    public void guard() {
        ...
        this.mood--;
        this.energy--;
        System.out.println(String.format("Your pet is bored hunger is %s, thirst is %s mood is %, energy is %s", this.hunger, this.thirst, this.mood, this.energy));
        this.checkPet();
    }

    public void game() {
        Scanner myScanner = new Scanner(System.in);
        System.out.println("What would you like to do with your pet? You can press 1 to play, 2 to eat, 3 to drink, 4 to pet or else they'll stand guard");
